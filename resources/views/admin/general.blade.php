                ...
                <div class="col-md-6">
                                <div class="c-contact">
                                    <div class="c-content-title-1">
                                        ...
                                        <p class="c-font-lowercase">Form</p>
                                    </div>
                                    <form action="#">
                                        <div class="form-group">
                                            <input placeholder="Your Name" class="form-control input-md" type="text"> </div>
                                        <div class="form-group">
                                            <input placeholder="Your Email" class="form-control input-md" type="text"> </div>
                                        <div class="form-group">
                                            <input placeholder="Contact Phone" class="form-control input-md" type="text"> </div>
                                        <div class="form-group">
